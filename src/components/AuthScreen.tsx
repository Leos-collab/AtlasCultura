      ...
      <main className="flex-1 flex items-center justify-center px-4 py-8 sm:py-12">
        <div className="w-full max-w-5xl grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
              ...
              <div className="grid grid-cols-4 p-2 bg-stone-950/80 backdrop-blur-md border-t border-stone-800 text-[11px] font-semibold text-center">
                {CULTURAL_VIBES.map((vibe, idx) => (
                  <button
                    ...
                    className={`py-1.5 px-2 rounded-xl transition-all cursor-pointer truncate ${
                      activeVibeIndex === idx
          ...
          <div className="lg:col-span-6 w-full max-w-lg mx-auto">
            {/* Card Container */}
            <div className={`rounded-3xl border shadow-2xl p-6 sm:p-8 transition-colors ${
              theme === 'dark'
              ...
              <div className={`mb-6 p-3.5 rounded-2xl border flex items-center justify-between gap-3 ${
                theme === 'dark'
                  ? 'bg-stone-950/70 border-amber-500/40 shadow-xs'
                  : 'bg-amber-50/80 border-amber-300 shadow-xs'
              }`}>
                <div className="flex items-center gap-2.5 min-w-0">
                  <div className="w-10 h-10 rounded-full bg-amber-400 text-stone-950 font-bold flex items-center justify-center shrink-0 shadow-xs">
                    LE
                  </div>
                  <div className="truncate">
                    <div className="flex items-center gap-1.5">
                      <p className="text-xs font-bold truncate">Leonardo Estivalet</p>
                    ...
                    <p className={`text-[11px] truncate ${theme === 'dark' ? 'text-stone-400' : 'text-stone-600'}`}>
                      leo.estivalet@gmail.com • Senha: Leo1406
                    </p>
                  </div>
                </div>
                <button
                  type="button"
                  id="btn-admin-login-leo"
                  onClick={handleAdminLogin}
                  className="px-3.5 py-2 bg-stone-900 dark:bg-amber-400 hover:bg-stone-800 dark:hover:bg-amber-300 text-amber-300 dark:text-stone-950 rounded-xl text-xs font-bold shadow-xs whitespace-nowrap transition-all cursor-pointer flex items-center gap-1.5 shrink-0"
                  title="Entrar diretamente com a conta de Administrador salva"
                >
              ...
              <div className={`flex items-center p-1 rounded-2xl mb-6 ${
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      placeholder="Digite sua senha (ex: Leo1406)"
                      className={`w-full pl-10 pr-4 py-2.5 rounded-xl border text-sm focus:outline-none transition-all ${
                        theme === 'dark'
                          ? 'bg-stone-950 border-stone-800 text-white focus:border-amber-400'
                          : 'bg-white border-stone-300 text-stone-900 focus:border-stone-900'
                ...
                <div className="text-center pt-1">
                  <button
                    ...
                    className={`text-xs hover:underline cursor-pointer ${
                      theme === 'dark' ? 'text-amber-400/80 hover:text-amber-300' : 'text-stone-600 hover:text-stone-900'
                    }`}
                  >
                    Entrar como Administrador (Leonardo Estivalet) →
                  </button>
                </div>
              </form>
            </div>
